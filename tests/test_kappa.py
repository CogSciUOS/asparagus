...
def test_kappa_equals_1_if_all_same():
    ...
    annotations1, _annotations = measure_agreement.load_annotations("labeling/annotations/template_structure_annotation/annotator_1.csv", "labeling/annotations/template_structure_annotation/annotator_1.csv")
