...
% hope this helps with floats
\usepackage{float}
%\usepackage{caption}
\usepackage{subcaption}

% hope this helps to keep floats to their sections
\usepackage{placeins}
...
% adjust images to move them to left and right side
...
% hoped I can use this for line break in long url links but seems not to work
...
% have two footnotes behind each other
\usepackage[multiple,hang,flushmargin]{footmisc}

% stretch vertical table sizes
\renewcommand{\arraystretch}{1.2}

% have influence on listing style
\usepackage{enumitem}

% help with special math symbols
\usepackage{amssymb}
...
\keywords{Classification, Computer Vision, ANN, CNN, Supervised Learning, Semi-supervised Learning, Unsupervised Learning} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
\university{\href{https://www.uni-osnabrueck.de/en/home.html}{Osnabr{\"u}ck University}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
%%%%% FLOAT STOPPING
% further redefinitions to have floats stop at subsections and not only sections
\makeatletter
\AtBeginDocument{%
...
% prevent words crossing the page margins
