...
\begin{table}[!htb]
	...
	\caption[Performance of the Semi-Supervised Convolutional VAE]{Performance of the semi-supervised convolutional \acrshort{vae}.}
