...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{Figures/chapter04/fe_palette_color}
	\decoRule
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{Figures/chapter04/head_example}
	\decoRule
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.8]{Figures/chapter04/head_curve}
	\decoRule
	...
	\centering
	\vspace{2cm}
	\includegraphics[scale=1.55]{Figures/chapter04/head_roc}
	\decoRule
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{Figures/chapter04/ftl_streamlit_app}
	\decoRule
	\caption[??]{??}
	\label{fig:FeaturetoLabelStreamlitApp}
	\centering
	\vspace{1cm}
	\includegraphics[scale=0.4]{Figures/chapter04/ftl_confusion_recall_random_forest}
	\decoRule
	\caption[??]{??}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.55]{Figures/chapter04/ftl_visualization}
	\decoRule
	\caption[??]{??}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{Figures/chapter04/ftl_classification_report}
	\decoRule
	\caption[??]{??}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{Figures/chapter04/autoencoder_latent_asparagus}
	\decoRule
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{Figures/chapter04/semi_supervised_network}
	\decoRule
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.35]{Figures/chapter04/semi_supervised_latent_asparagus}
	\decoRule
