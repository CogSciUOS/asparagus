...
def show_images(images, cols = 1, titles = None):
    ...
    fig = plt.figure()
    fig.suptitle("First 10 Eigenasparagus hollow", fontsize=120, fontweight='bold')
...
if __name__ == '__main__':
    path = "/net/projects/scratch/winter/valid_until_31_July_2020/asparagus/preprocessed_images/data_hollow/"
