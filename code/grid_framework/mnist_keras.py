...
if __name__ == "__main__":
        ...
        for n_neurons in range(100,500,100):
            if args.mode == "local":
                ...
                #Mind that you can use the very same list of arguments as before ([n_neurons, "adam",1]).
                #Consider to submit gridjob with more than zero cuda cores if GPU computation is required.
                submit_script(os.getcwd()+"/mnist_keras_local.py",[n_neurons, "adam",1], environment)
