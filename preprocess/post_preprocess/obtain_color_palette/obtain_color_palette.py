from grid import *
import argparse
from obtain_color_palette_local import *
...
if __name__ == "__main__":
        ...
        path = "/net/projects/scratch/winter/valid_until_31_July_2020/mgerstenberg/asparagus/code/preprocess/post_preprocess/obtain_color_palette/obtain_color_palette_local.py"
        if args.mode == "local":
            from obtain_color_palette_local import main
            main()
        else:
